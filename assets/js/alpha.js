  ...
  $.fn.alpha = function(options) {
    ...
    $('#testimonials').closest('html').find('head').append(style);
     ...
     //set selected testimonal active
      $('#testimonials').find('.customer').eq(act).addClass('active').find('.testimonial-bubble').addClass('fadeInDown').closest('.customer').find('.cus-profile').find('.cus-name').fadeIn(200, function(){ $(this).css('bottom', '75px')});    
      //set selected testimonal active
